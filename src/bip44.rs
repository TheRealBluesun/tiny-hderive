...
impl FromStr for DerivationPath {
    ...
    fn from_str(path: &str) -> Result<DerivationPath, Error> {
        ...
        Ok(DerivationPath {
            path: path
                .map(str::parse)
                .collect::<Result<Vec<ChildNumber, U128>, Error>>()?,
        })
    }
}
...
mod tests {
    ...
    fn derive_path() {
        ...
        let test_path = Vec::<ChildNumber, U128>::from_iter(
            [
        ...
        assert_eq!(path, DerivationPath { path: test_path });
    }
}
